...
--
-- Host: localhost:3306
-- Generation Time: Dec 04, 2018 at 01:44 PM
...
INSERT INTO `directors` (`directorid`, `firstname`, `lastname`, `birthday`, `nationality`, `photo`) VALUES
...
(4, 2, 6, '', ''),
(5, 3, 2, '', ''),
(6, 3, 1, '', 'Elgin Theatre is used in the Shape of Water, and is also actually where the world premiere of the film was held during TIFF\r\n'),
(7, 4, 3, '', ''),
(8, 4, 4, '', '');
...
--
-- Dumping data for table `location-user-tips`
--

INSERT INTO `location-user-tips` (`id`, `locationid`, `filmid`, `userid`, `tip`, `dateadded`) VALUES
(1, 1, 0, 2, 'Riding up in century old elevator cars (refurbed obv.) to a beautiful theatre sets such a great tone for any movie going experience. Even better when it is a TIFF launch!', '2018-12-03');
...
(2, 'test', 'test', 'Cleo', '', 'lantc@sheridancollege.ca', '2018-11-22', 'female', 'Profile_01.png', 'gta', 'casual'),
