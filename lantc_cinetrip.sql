...
--
-- Host: localhost:3306
-- Generation Time: Nov 11, 2018 at 03:12 PM
...
(1, 1, 'Sally', 'Hawkins', 1976, 'English', ''),
(2, 2, 'Doug', 'Jones', 1960, 'American', ''),
(3, 3, 'Tatiana', 'Maslany', 1985, 'Canadian', ''),
(4, 4, 'Dylan', 'Bruce', 1980, 'Canadian', ''),
(5, 5, 'Daniel', 'Radcliffe', 1989, 'English', ''),
(6, 6, 'Zoe', 'Kazan', 1983, 'American', ''),
(7, 7, 'Hugh', 'Dancy', 1975, 'English', ''),
(8, 8, 'Mads', 'Mikkelsen', 1965, 'Danish', '');
...
(1, 'Hannibal', '2013-04-14', 1, 0, ''),
(2, 'Orphan Black', '2013-03-30', 1, 0, ''),
(3, 'The Shape of Water', '2017-09-11', 0, 1, ''),
(4, 'The F Word', '2013-09-07', 0, 1, '');
...
(1, 1, 7, 'Season 3', 'The psych hospital’s exterior is the (again, augmented) administration building of Richmond Hill’s David Dunlap Observatory.');
...
INSERT INTO `locations` (`id`, `address`, `name`, `description`, `tips`, `photo`, `mapurl`) VALUES
